...
SECRET_KEY = 'django-insecure-eq0_&#gkvyg!4reridl*dgq@b1zjsk6l2_a50jlg=6opo&my=r'
...
'''Realizar configuração global dos filtros no projeto.
Adicionar a configuração DEFAULT_FILTER_BACKENDS, incluindo 
DjangoFilterBackend, 
OrderingFilter 
e SearchFilter.'''
